...
#		_list_new = "/".join(("/var/www/cgi-bin", _list[-2], _list[-1]))
#		print _list[-2:]

	#debug
#	print file_path_src_html
#	print file_path_dst_html
...
#		if res == 1: print "Dir created: %s" % _list
...
#	_list = file_path_dst[0].split("/")
	...
	#debug
#	print ssh, file_path_src, file_path_dst, yes_flag
#	sys.exit()

	# create files list -----------------------------------
	#debug
#	print os.path.dirname(file_path_src[0])
#	sys.exit()
...
#	file_path_dst_html = _get_file_path_dst_html(os.path.dirname(file_path_src_html))
...
def do_upload2():
	...
	#debug
#	print username, file_path_src, file_path_dst, \
#		modnum, passwd, yes_flag, flag_hyb
#
##	print file_path_dst[0].split(os.sep)
#	print file_path_dst[0].split("/")
#	sys.exit()
