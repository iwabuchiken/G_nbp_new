...
# vars and constants ========================
VERSION = [4.5, "2011/06/27-12:50:52"]
...
def do_job(): 
  ...
  if len(args) < 2:
    print usage
    sys.exit(0)
  username, file_path_src, file_path_dst, modnum, passwd = handle_args(args)

  #debug
  print username, file_path_src, file_path_dst, modnum, passwd
